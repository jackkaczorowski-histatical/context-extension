...
DO NOT extract: common English words everyone knows (nobility, clergy, counterfeiting, black markets, central banks, liquidity), generic phrases (royal accounts, fiscal crisis, French monarchy, French crown, foreign bankers, debt spiral). NEVER extract standalone years as entities (1788, 1792, 1795, 1800, 1720). NEVER extract countries as entities (Greece, Zimbabwe, France, Britain) unless the country name is part of a specific institution like "Bank of France".
