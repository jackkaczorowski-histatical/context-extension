(() => {
  ...
  chrome.storage.onChanged.addListener((changes) => {
    if (changes.extensionSettings) {
      ...
      if (sidebar && old.sidebarPosition !== settings.sidebarPosition) {
  ...
  function applySidebarPosition() {
    ...
    if (settings.sidebarPosition === 'left') {
      ...
      sidebar.style.borderRight = '1px solid #2a2a3e';
      sidebar.style.boxShadow = '4px 0 24px rgba(0, 0, 0, 0.4)';
    } else {
      sidebar.style.left = 'auto';
      sidebar.style.right = '0';
      sidebar.style.borderRight = 'none';
      sidebar.style.borderLeft = '1px solid #2a2a3e';
      sidebar.style.boxShadow = '-4px 0 24px rgba(0, 0, 0, 0.4)';
    }
  }
  ...
  function createSidebar() {
    ...
    style.textContent = `
      ...
      #context-sidebar.position-left.open {
        transform: translateX(0);
      }
